...
public class LexicalAnalyzerWirth {
	
	private final FileParser fileParser;
	private final EventQueue eventQueue;
	private final StringBuilder readFile;
	
	private final TransducerWirth transducer;
	
	private boolean trackSwitch;

	public LexicalAnalyzerWirth(String fileName) throws FileNotFoundException {
		fileParser = new FileParser(fileName);
		eventQueue = new EventQueue();
		readFile = new StringBuilder();
		
		transducer = new TransducerWirth();
